...
用法：
    python handbook/scripts/maint/gen_favicon.py              # 写 theme/assets/favicon.svg
    python handbook/scripts/maint/gen_favicon.py --preview d  # 另存 16/32/256 预览 PNG 到目录 d
