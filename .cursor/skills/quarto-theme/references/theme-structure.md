...
本文件规定 `.cursor/skills/quarto-theme/assets/theme/scss/`（主题变量）与 `.cursor/skills/quarto-theme/assets/theme/css/`（组件规则）下各文件的职责、组件规则要点、以及**新增配色/callout/组件的流程**。渲染/缓存命令以 `AGENTS.md` 为准；令牌表见 `design-tokens.md`。
