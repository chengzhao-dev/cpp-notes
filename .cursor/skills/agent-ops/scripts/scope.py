...
零新增元数据：路由表就是 .cursor/skills/cpp-content/references/tasks/<part>.md 任务矩阵。
...
ALWAYS_DENY = [
    "_book/**（渲染产物：校验走 .cursor/skills/agent-ops/scripts/check_dom_contracts.py，不直接读）",
...
DOMAIN_READ = {
    "theme": [".cursor/skills/quarto-theme/SKILL.md",
              ".cursor/skills/quarto-theme/references/theme-system.md",
              ".cursor/skills/quarto-theme/assets/theme/css/"],
    "dev": [".cursor/skills/agent-ops/assets/config/editorconfig",
            ".cursor/skills/python-tools/scripts/scaffold/"],
    "repo": ["AGENTS.md", ".cursor/skills/catalog.md",
             ".cursor/skills/agent-ops/references/repository-structure.md"],
}
...
def main():
    ...
    if not unit:
        ...
        print("章节须先在 .cursor/skills/cpp-content/references/tasks/<part>.md 任务矩阵登记；")
