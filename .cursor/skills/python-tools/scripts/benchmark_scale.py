...
用法：
    python .cursor/skills/python-tools/scripts/benchmark_scale.py                # 默认 1k/10k/50k/100k
    python .cursor/skills/python-tools/scripts/benchmark_scale.py --sizes 1000,10000 --repeats 5
