...
用法：
    python .cursor/skills/python-tools/scripts/maintenance/generate_favicon.py              # 写 .cursor/skills/quarto-theme/assets/theme/assets/favicon.svg
    python .cursor/skills/python-tools/scripts/maintenance/generate_favicon.py --preview d  # 另存 16/32/256 预览 PNG 到目录 d
...
def main():
    ...
    out = Path(".cursor/skills/quarto-theme/assets/theme/assets")
