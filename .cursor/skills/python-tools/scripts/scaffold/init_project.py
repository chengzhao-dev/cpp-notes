...
仓库根目录已配置好 Python 时，也可以使用：
  python .cursor/skills/python-tools/scripts/scaffold/init_project.py --name first-program --dir code/getting-started

用法：python .cursor/skills/python-tools/scripts/scaffold/init_project.py --name <name> [--dir code/<part>]
退出码：0 成功；1 参数/路径错误。
"""
