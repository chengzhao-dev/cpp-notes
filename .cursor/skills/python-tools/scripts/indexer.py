...
用法：
    python .cursor/skills/python-tools/scripts/indexer.py              # 增量构建（先跑 chunker）
    python .cursor/skills/python-tools/scripts/indexer.py --rebuild    # 推倒重建
    python .cursor/skills/python-tools/scripts/indexer.py --verbose    # 打印每层的行数与耗时
