...
- **必读**: `AGENTS.md`；本文件；`.cursor/skills/cpp-content/references/cpp/stl.md`；`.cursor/skills/quarto-docs/references/quarto/authoring.md`；`.cursor/skills/quarto-docs/references/zh/writing-style-core.md`
