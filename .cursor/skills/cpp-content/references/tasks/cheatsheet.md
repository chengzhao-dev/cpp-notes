...
本文件是 cheatsheet 全部章节任务的唯一权威记录：一行一章，读写边界与验收在文件级统一，只有差异写进行内。改状态只改本表「状态」列，仓库内不存在其它 INDEX 文件。
...
| --- | --- | --- | --- | --- | --- | --- | --- |
| `TASK-CS-001` | syntax-ref | todo | `TASK-CORE-008` | `content/cheatsheet/syntax-ref.qmd` | `code/cheatsheet/syntax-ref.cpp` | `.cursor/skills/cpp-content/references/cpp/cpp.md` | — |
| `TASK-CS-002` | stl-ref | todo | `TASK-STL-005` | `content/cheatsheet/stl-ref.qmd` | `code/cheatsheet/stl-ref.cpp` | `.cursor/skills/cpp-content/references/cpp/stl.md` | — |
