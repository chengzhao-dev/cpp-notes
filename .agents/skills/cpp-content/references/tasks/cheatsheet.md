...
| --- | --- | --- | --- | --- | --- | --- | --- |
| `TASK-CS-001` | syntax-ref | todo | `TASK-CORE-008` | `content/cheatsheet/syntax-ref.qmd` | `code/cheatsheet/syntax-ref.cpp` | `.agents/skills/cpp-content/references/cpp/cpp.md` | — |
| `TASK-CS-002` | stl-ref | todo | `TASK-STL-005` | `content/cheatsheet/stl-ref.qmd` | `code/cheatsheet/stl-ref.cpp` | `.agents/skills/cpp-content/references/cpp/stl.md` | — |
