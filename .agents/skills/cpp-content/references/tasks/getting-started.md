...
| `TASK-ENV-006` | multi-file-project | done | `TASK-ENV-005` | `content/getting-started/multi-file-project.qmd` | `code/getting-started/multi-file-project/` | `.agents/skills/cpp-content/references/cpp/engineering.md` | 单个 app 目标。使用 include/ 与 src/ 组织多文件工程，src/ 直属 .cpp 由 GLOB 收集 |
