...
- **必读**: `AGENTS.md`、本文件、`.agents/skills/quarto-docs/references/quarto/authoring.md`、`.agents/skills/quarto-docs/references/zh/cpp-chapter-writing.md`、`.agents/skills/quarto-docs/references/zh/writing-style-core.md`
...
| `TASK-ENV-003` | first-program | done | `TASK-ENV-001` | `content/getting-started/first-program.qmd` | `code/getting-started/first-program/` | `.agents/skills/cpp-content/references/cpp/cpp.md` | 先直接编译，再最小 CMakeLists。多文件与目标留给 cmake-intro |
