...
| `TASK-LANG-006` | arrays-strings | todo | `TASK-LANG-005` | `content/language-basics/arrays-strings.qmd` | `code/language-basics/arrays-strings.cpp` | — | — |
| `TASK-LANG-007` | structs-classes | todo | `TASK-LANG-006` | `content/language-basics/structs-classes.qmd` | `code/language-basics/structs-classes.cpp` | — | — |
| `TASK-LANG-008` | references | todo | `TASK-LANG-007` | `content/language-basics/references.qmd` | `code/language-basics/references.cpp` | — | — |
