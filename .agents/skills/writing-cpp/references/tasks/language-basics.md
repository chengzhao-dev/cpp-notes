...
| --- | --- | --- | --- | --- | --- | --- | --- |
| `TASK-LANG-001` | types-and-variables | done | `TASK-ENV-004` | `content/language-basics/types-and-variables.qmd` | `code/language-basics/types-and-variables.cpp` | `.agents/skills/writing-cpp/references/cpp/language-basics.md` | 只讲基础类型、变量、全局/块作用域，不使用 `std::string` |
| `TASK-LANG-002` | initialization-and-type-inference | done | `TASK-LANG-001` | `content/language-basics/initialization-and-type-inference.qmd` | `code/language-basics/initialization-and-type-inference.cpp` | `.agents/skills/writing-cpp/references/cpp/language-basics.md` | 列表初始化、赋值、`auto` 与初始化列表推导 |
| `TASK-LANG-003` | constants | done | `TASK-LANG-002` | `content/language-basics/constants.qmd` | `code/language-basics/constants.cpp` | `.agents/skills/writing-cpp/references/cpp/language-basics.md` | 讲 `const`、`constexpr` 与领域中性的阈值和比例 |
| `TASK-LANG-004` | type-safety-and-numeric-bounds | done | `TASK-LANG-003` | `content/language-basics/type-safety-and-numeric-bounds.qmd` | `code/language-basics/type-safety-and-numeric-bounds.cpp` | `.agents/skills/writing-cpp/references/cpp/primitive-types-and-numeric-safety.md` | 类型范围、符号、溢出、转换、浮点、`bool` 与 `std::size_t` |
