...
| --- | --- | --- | --- | --- | --- | --- | --- |
| `TASK-REF-001` | syntax | todo | `TASK-LANG-008` | `content/reference/syntax.qmd` | `code/reference/syntax.cpp` | `.agents/skills/cpp-content/references/cpp/cpp.md` | — |
| `TASK-REF-002` | standard-library | todo | `TASK-STD-005` | `content/reference/standard-library.qmd` | `code/reference/standard-library.cpp` | `.agents/skills/cpp-content/references/cpp/stl.md` | — |
