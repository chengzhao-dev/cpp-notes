...
本项目是个人维护的中文 C++ 笔记，面向 C++ 初学者，供作者查阅和新人阅读，不写成课程、教材或学习书。公开页面统一使用“笔记、内容、部分、页面、阅读顺序”等中性词，项目自称和读者导航避免“学习笔记、学习内容、学习路线、分册、开始学习”；通用写作规范中描述文体时仍可使用“教程、教学正文”。项目自称使用“这份笔记”，不使用“本书”。运行环境以 Linux 为准，Windows 读者通过 WSL2 获得同样环境。正文优先使用 C++20 语义，示例必须能编译、运行并与正文输出一致。
